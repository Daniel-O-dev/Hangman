...
class Hangman extends Component {
  ...
  guessedWord() {
    return this.state.answer
      // splits the array (guessed word) into individual letters
      .split("")
  ...
  render() {
    ...
    let gamesState = this.generateButtons();
    if (isWinner) gamesState = 'You Win !';
    if (isgameOver) gamesState = 'You Lose !';
